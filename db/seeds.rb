...
b1 = Box.create(name: 'The London Box', description: 'Look like you speak the Queen\'s English.', frequency: 'weekly', ship_date: '2013-02-02', price: 120)
b2 = Box.create(name: 'The Surf Club', description: 'For the surfer in us all', frequency: 'biweekly', ship_date: '2013-02-03', price: 150)
b3 = Box.create(name: 'The Luxury Box', description: 'The box of life.', frequency: 'monthly', ship_date: '2013-02-03', price: 75)
b4 = Box.create(name: 'The Manhattan', description: 'Live like you live in Manhttan', frequency: 'monthly', ship_date: '2013-02-03', price: 90)
b5 = Box.create(name: 'Peace of Mind Collection', description: 'Love and peace for the new age.', frequency: 'monthly', ship_date: '2013-02-03', price: 75)
b6 = Box.create(name: 'Urban Sampler', description: 'Fine urban clothing for the urban man.', frequency: 'monthly', ship_date: '2013-02-03', price: 110)
...
i10 = Item.create(name: 'Sandals', description: 'cool sandals', img: "pics/crop-10.png")
i11 = Item.create(name: 'Shoes', description: 'cool shoes', img: "pics/crop-11.png")
i12 = Item.create(name: 'Sandals', description: 'cool sandals', img: "pics/crop-12.png")
...
b2.shipments << sh1
sh1.items << i1 << i2 << i3 << i4 << i5 << i6 << i7 << i8 << i9 << i10 << i11 << i12
b1.shipments << sh1
i1.tags << t1 << t2
i2.tags << t1 << t3
